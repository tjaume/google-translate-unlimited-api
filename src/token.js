// refer: https://github.com/hua1995116/google-translate-open-api/blob/master/src/token.js#L15
...
export async function getTK(text, domain) {
    return updateTKK(domain)
        .then(function () {
            var tk = sM(text);
            tk = tk.replace('&tk=', '');
